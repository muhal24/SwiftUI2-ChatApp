...
//  SwiftUI2-ChatApp
//
//  Created by Muhammed Hanifi Alma on 29.01.2021.
//
    ...
    var body: some View{
                    ...
                    if message != ""{
                        ...
                        Button(action: {
                            ...
                            withAnimation(.easeIn){
                                ...
                                allMessages.messages.append(Message(id: Date(), message: message, myMsg: true, profilePic: "muhal24", photo: nil))
                            }
        ...
        .fullScreenCover(isPresented: self.$imagePicker, onDismiss: {
            ...
            if self.imgData.count != 0{
                ...
                allMessages.writeMessage(id: Date(), msg: "", photo: self.imgData, myMsg: true, profilePic: "muhal24")
            }
...
class Messages : ObservableObject{
    ...
    init() {
        ...
        let strings = ["Hey","Hey !!!!","How are u?","cool, You???","Same tnx ",":)","How is weather bro?","so cold bro","here as well"]
        
        //simple logic for two side messages
        
        for i in 0..<strings.count{
            
            messages.append(Message(id: Date(), message: strings[i], myMsg: i % 2 == 0 ? true : false, profilePic: i % 2 == 0 ? "muhal24" : "profile"))
        }
    }
